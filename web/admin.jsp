...
<head>
    ...
    <style>
        ...
        .bg-category { background-color: #5c6bc0; }
        .bg-service  { background-color: #26a69a; }
        .bg-feedback { background-color: #ef5350; }
        .bg-post     { background-color: #42a5f5; }
        .card-body h4 {
            margin: 10px 0;
        }
        .btn-manage {
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="manageCategories" class="btn btn-sm btn-primary btn-manage">Manage</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <h4>Invoices</h4>
                    <p>Total: ${postCount}</p>
                    <a href="manageInvoices" class="btn btn-sm btn-primary btn-manage">Manage</a>
                </div>
            </div>
        </div>
